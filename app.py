...
st.markdown("2025년 12월 17일부터 현재까지의 실제 주가 변화 및 수익률 격차를 실시간으로 추적합니다.")
...
with tab1:
    ...
    df1 = df_raw[["그룹", "투자기업", "투자_최초주가", "투자_현재주가", "투자_수익률(%)"]].copy()
...
with tab2:
    ...
    df2 = df_raw[["그룹", "투자기업", "투자_수익률(%)", "미투자기업", "미투자_수익률(%)", "수익률격차(%p)"]].copy()
